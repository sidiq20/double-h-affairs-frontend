      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-amber-700 text-lg max-w-xl mx-auto leading-relaxed font-serif font-light">
            No physical gift allowed. Your presence is the greatest gift we could ever ask for. However if you would still like to Honour us with a gesture, we would be deeply grateful if such  is monetized.
          </p>
        </div>
